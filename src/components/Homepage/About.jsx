            ...
            <div className="grid grid-cols-2 gap-6 mt-12">
              ...
              <div className="group relative">
                ...
                <div className="relative bg-slate-800/80 backdrop-blur-lg border border-cyan-400/40 rounded-3xl p-8 text-center group-hover:transform group-hover:scale-110 transition-all duration-500">
                  ...
                  <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-300 mb-2">UAE's #1</div>
                  <p className="text-blue-200 font-medium">Marble Importer</p>
                </div>
              </div>
            </div>
              ...
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="group relative">
                  ...
                  <div className="relative aspect-square rounded-3xl overflow-hidden border border-blue-500/30 shadow-2xl group-hover:shadow-blue-500/25 transition-all duration-700">
                    ...
                    {/* Overlay effects */}
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 via-transparent to-cyan-600/10 opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
                    
                    {/* Animated border */}
                    <div className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-cyan-400/50 transition-all duration-700"></div>
                    
                    {/* Corner accent */}
                    <div className="absolute top-4 right-4 w-3 h-3 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 animate-pulse"></div>
                  </div>
                  
                  {/* Floating effect */}
                  <div className="absolute inset-0 transform group-hover:scale-105 group-hover:-translate-y-2 transition-all duration-700"></div>
                </div>
              ))}
            </div>
          </div>
